...
6. Клиенту `forestmap-drone-dedicated` добавить маппер ( по конфигурации, Hardcoded claim). Значение <COMPANY_ID_SECRET> (имя и токен - `company_id`), совпадающее с секретом в seed.sql. Например `f2e67fd0-test-496a-ac02-a1ffcc6274ef`
